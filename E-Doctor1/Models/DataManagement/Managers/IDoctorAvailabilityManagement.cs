...
namespace ErgasiaMVC.Models.DataManagement.Managers
{
    ...
    {
        void createAvailableDate(int day, TimeSpan starting_time, TimeSpan ending_time, Doctor doctor);
        ...
        void editAvailableDate(int available_date_id, int day, TimeSpan starting_time, TimeSpan ending_time, Doctor doctor);
    }
}
